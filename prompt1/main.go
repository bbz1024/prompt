...
const prompt2 = `Extract 3 to 4 chinese keywords from this video text about to help with video classification.`
const prompt3 = `
...
func main() {
	...
	res, err := newGpt.ChatWithModel(context.TODO(), prompt3, videoText)
	if err != nil {
		panic(err)
	}
	fmt.Println(res)
